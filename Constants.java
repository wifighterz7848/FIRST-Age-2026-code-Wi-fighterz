...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kWheelBase = Units.inchesToMeters(26.4);
  ...
  public static final class DIOPortAssignments {
    public static final int kIntakeSensor1=0;        // IO Port 0
    public static final int kIntakeSensor2=1;        // IO Port 1
    public static final int kElevatorLowerLimit=2;    // IO Port 2
    public static final int kElevatorLowerLimit2=6; 
